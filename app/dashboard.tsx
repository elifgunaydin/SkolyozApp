...
const styles = StyleSheet.create({
  ...
  headerBackground: { backgroundColor: '#2563eb', height: 220, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, paddingHorizontal: 24, paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 0) + 20 : 60 },
